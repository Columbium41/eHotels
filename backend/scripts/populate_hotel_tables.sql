...
INSERT INTO Hotel (hotel_id, hotel_chain_name, rating, street, city, region, country, email, phone_number) VALUES 
    (0, 'Hilton', 3, '123 That St' , 'RandomPlace', 'Ontario', 'Canada', 'hotel0@example.com', '133-551-5989'),
    (1, 'Hilton', 3, '123 Main St', 'Anytown', 'New York',  'USA', 'hotel1@example.com', '321-098-5672'),
    (2, 'Hilton', 3, '123 Second St', 'Anytown', 'New York', 'USA', 'hotel2@example.com', '123-456-7890'),
    (3, 'Hilton', 4, '456 Elm St', 'Othertown', 'British Columbia', 'Canada', 'hotel3@example.com', '198-765-4321'),
    (4, 'Hilton', 2, '789 Oak St', 'Anycity', 'California', 'USA', 'hotel4@example.com', '135-792-4680'),
    (5, 'Hilton', 5, '321 Maple St', 'Anystate', 'Texas', 'USA', 'hotel5@example.com', '102-938-4756'),
    (6, 'Hilton', 3, '654 Pine St', 'Othercity', 'Alberta', 'Canada', 'hotel6@example.com', '174-205-8963'),
    (7, 'Hilton', 4, '987 Cedar St', 'Anothercity', 'Florida', 'USA', 'hotel7@example.com', '109-876-5432'),
    (8, 'Marriott', 2, '654 Birch St', 'Yetanothercity', 'Manitoba', 'Canada', 'hotel8@example.com', '162-738-4950'),
    (9, 'Marriott', 3, '321 Willow St', 'Finalcity', 'Ontario', 'Canada', 'hotel9@example.com', '182-736-4950'),
    (10, 'Marriott', 3, '456 Elm St', 'Othertown', 'Utah', 'USA', 'hotel10@example.com', '987-654-3210'),
    (11, 'Marriott', 5, '789 Maple St', 'Anystate', 'Ohio', 'USA', 'hotel11@example.com', '456-789-0123'),
    (12, 'Marriott', 2, '321 Pine St', 'Othertown', 'Utah', 'USA', 'hotel12@example.com', '654-321-0987'),
    (13, 'Marriott', 4, '987 Cedar St', 'Anothercity', 'Quebec', 'Canada', 'hotel13@example.com', '321-098-7654'),
    (14, 'Marriott', 3, '654 Birch St', 'Yetanothercity', 'Saskatchewan', 'USA', 'hotel14@example.com', '789-012-3456'),
    (15, 'Marriott', 3, '123 Willow St', 'Finalcity', 'Yukon', 'Canada', 'hotel15@example.com', '890-123-4567'),
    (16, 'Millennium', 4, '456 Cedar St', 'Lastcity', 'Washington', 'USA', 'hotel16@example.com', '234-567-8901'),
    (17, 'Millennium', 4, '123 Oak St', 'Anycity', 'Colorado', 'USA', 'hotel17@example.com', '111-222-3333'),
    (18, 'Millennium', 3, '456 Elm St', 'Othertown', 'British Columbia', 'Canada', 'hotel18@example.com', '444-555-6666'),
    (19, 'Millennium', 5, '789 Maple St', 'Anystate', 'Newfoundland and Labrador', 'Canada', 'hotel19@example.com', '777-888-9999'),
    (20, 'Millennium', 2, '321 Pine St', 'Othercity', 'British Columbia', 'Canada', 'hotel20@example.com', '123-656-7890'),
    (21, 'Millennium', 4, '987 Cedar St', 'Lastcity', 'North Carolina', 'USA', 'hotel21@example.com', '334-567-8901'),
    (22, 'Millennium', 3, '654 Birch St', 'Yetanothercity', 'West Virgina', 'USA', 'hotel22@example.com', '345-678-9012'),
    (23, 'Millennium', 4, '123 Willow St', 'Finalcity', 'Texas', 'USA', 'hotel23@example.com', '596-789-0123'),
    (24, 'Travelodge', 3, '456 Cedar St', 'Lastcity', 'Ontario', 'Canada', 'hotel24@example.com', '567-890-1234'),
    (25, 'Travelodge', 4, '123 Oak St', 'Anycity', 'Alberta', 'Canada', 'hotel25@example.com', '813-222-3333'),
    (26, 'Travelodge', 3, '456 Elm St', 'Othertown', 'Mississippi', 'USA', 'hotel26@example.com', '928-555-6666'),
    (27, 'Travelodge', 5, '789 Maple St', 'Yetanothercity', 'Arizona', 'USA', 'hotel27@example.com', '727-888-9999'),
    (28, 'Travelodge', 2, '321 Pine St', 'Othercity', 'Mississippi', 'USA', 'hotel28@example.com', '115-456-7890'),
    (29, 'Travelodge', 4, '987 Cedar St', 'Anothercity', 'Hawaii', 'USA', 'hotel29@example.com', '201-567-8901'),
    (30, 'Travelodge', 3, '654 Birch St', 'Yetanothercity', 'Arizona', 'USA', 'hotel30@example.com', '345-678-9012'),
    (31, 'Travelodge', 4, '123 Willow St', 'Finalcity', 'Kansas', 'USA', 'hotel31@example.com', '456-789-0123'),
    (32, 'GreenTree Inns', 4, '123 Oak St', 'Anycity', 'Nunavut', 'Canada', 'hotel32@example.com', '129-222-3333'),
    (33, 'GreenTree Inns', 3, '456 Elm St', 'Anycity', 'Nunavut', 'Canada', 'hotel33@example.com', '768-555-6666'),
    (34, 'GreenTree Inns', 5, '789 Maple St', 'Anystate', 'Saskatchewan', 'Canada', 'hotel34@example.com', '682-209-9999'),
    (35, 'GreenTree Inns', 2, '321 Pine St', 'Othercity', 'California', 'USA', 'hotel35@example.com', '178-456-7890'),
    (36, 'GreenTree Inns', 4, '987 Cedar St', 'Anothercity', 'Missouri', 'USA', 'hotel36@example.com', '573-567-8901'),
    (37, 'GreenTree Inns', 3, '654 Birch St', 'Yetanothercity', 'Manitoba', 'Canada', 'hotel37@example.com', '987-678-9012'),
    (38, 'GreenTree Inns', 4, '123 Willow St', 'Finalcity', 'Hawaii', 'USA', 'hotel38@example.com', '788-789-0123'),
    (39, 'GreenTree Inns', 3, '456 Cedar St', 'Lastcity', 'Vermont', 'USA', 'hotel39@example.com', '333-890-1234');
